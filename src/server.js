...
app.listen(process.env.SERVER_PORT || 3000, () => {
    ...
    console.log("   Standard: http://localhost:" + (process.env.SERVER_PORT || 3000) + "/auth/v1/google");
    console.log("   Hash-based: http://localhost:" + (process.env.SERVER_PORT || 3000) + "/auth/v1/google/hash");
    console.log("   Test: http://localhost:" + (process.env.SERVER_PORT || 3000) + "/auth/v1/test-token");
});