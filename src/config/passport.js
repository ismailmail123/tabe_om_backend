...
//                 console.log("Eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeexisting user check:", existingUser ? existingUser.email : "No existing user");
...
//                 console.log("Nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnew user created with role:", newUser.role);
//                 return done(null, newUser);
//             } catch (error) {
